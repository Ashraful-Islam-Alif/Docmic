...
const Department = () => {
    return (
        <div id='department' class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 py-12">

            <div class="col-span-2">
                <p className='text-violet-800 py-4'>16+ Years Experiences </p>
                <h1 className='lg:text-5xl text-lg font-medium'>We Are Always ensure Best Medical Treatment For Your Health</h1>
